...
This skill describes how to fill the **Intent block** (defined in the parent `data-agent-skill/SKILL.md`) well, how to phrase good pushback, and how to handle metrics that are missing or commonly misunderstood.
...
Example that qualifies: *"How many rows in `analytics_prd.gold_task_created_daily` from 2026-05-20 to 2026-05-27?"*
